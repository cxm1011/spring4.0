...
public class LoggingAspect {
    ...
    // 后面直接使用切入点表达式即可  不用每个都需要写 execution(public int logging_annotation.aop.impl.ArithmeticCalculartorImpl.*(int,int))
    @Pointcut("execution(public int logging_annotation.aop.impl.ArithmeticCalculartorImpl.*(int,int))")
